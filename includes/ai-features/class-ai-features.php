...
class AI_Features {
	 ...
	 * Constructor.
	 *
	 * @param \PRC\Platform\Block_Tables\Loader $loader The loader that's responsible for maintaining and registering all hooks that power the plugin.
	 */
	...
	/**
	 * Load table AI feature classes and register features with the WP AI plugin.
	 *
	 * @return void
	 */
	public function register_wp_ai_features() {
		...
		add_action(
			...
			function ( $registry ) {
				$registry->register_feature( new Generate_Tabular_Data_Feature() );
			}
		);
	}
}
