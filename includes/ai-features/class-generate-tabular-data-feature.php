...
class Generate_Tabular_Data_Feature extends Abstract_Feature {
	...
	protected function load_metadata(): array {
		return array(
			'label'       => __( 'Table Generation', 'prc-block-tables' ),
			'description' => __( 'Uses AI to generate tabular data based on Pew Research Center content. Adds a "Suggest with AI" control to the Power Table block in the editor.', 'prc-block-tables' ),
	...
	public function enqueue_feature_assets(): void {
		$asset_file = PRC_BLOCK_TABLES_DIR . '/includes/ai-features/build/generate-tabular-data/index.asset.php';
		...
		wp_enqueue_script(
			...
			plugins_url( 'includes/ai-features/build/generate-tabular-data/index.js', PRC_BLOCK_TABLES_FILE ),
			$asset['dependencies'],
			$asset['version'],
			true
		);
