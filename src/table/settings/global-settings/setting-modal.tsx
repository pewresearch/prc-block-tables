								...
								<Flex wrap align="stretch">
									...
									>
										<ColorControl
											label={createInterpolateElement(
												__(
													'Cell text color ( <code>th</code> tag )',
													'flexible-table-block'
												),
												{ code: <code /> }
											)}
									...
									>
										<ColorControl
											label={createInterpolateElement(
												__(
													'Cell text color ( <code>td</code> tag )',
													'flexible-table-block'
												),
												{ code: <code /> }
											)}
									...
									>
										<BorderWidthControl
											...
											values={{
												top: currentOptions.block_style
													?.cell_border_width,
											}}
											allowSides={false}
											hasIndicator={false}
							...
							<VStack spacing={4}>
								...
								{(currentOptions.show_label_on_section ||
									...
									<ToggleControl
										...
										checked={
											!!currentOptions.focus_control_button
										}
										onChange={(value) => {
											setCurrentOptions({
												...currentOptions,
								...
								<ToggleControl
									label={__(
										'Keep all contents when merging cells',
										'flexible-table-block'
									)}
									help={__(
