...
class Table {
	...
	public function init( $loader = null ) {
		require_once PRC_BLOCK_TABLES_DIR . '/build/table/class-helper.php';
		require_once PRC_BLOCK_TABLES_DIR . '/build/table/class-settings.php';
		require_once PRC_BLOCK_TABLES_DIR . '/build/table/class-api.php';
		require_once PRC_BLOCK_TABLES_DIR . '/build/table/class-round-display.php';
		require_once PRC_BLOCK_TABLES_DIR . '/build/table/class-table-rounding-walker.php';
	...
	public function block_init() {
		register_block_type_from_metadata(
			PRC_BLOCK_TABLES_DIR . '/build/table',
			array(
